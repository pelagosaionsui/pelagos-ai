  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="text-center space-y-6 max-w-3xl mx-auto">
        ...
        <p className="text-xl text-gray-600">The Autonomous and Composable AI Agent Framework on Sui</p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
        <a href="https://github.com/pelagosaionsui" target="_blank" rel="noopener noreferrer">
          <Button size="lg" className="bg-[#6C5CE7] hover:bg-[#5A4BD5] text-white w-full sm:w-auto">
